import{_ as a,p as s,q as n,a1 as e}from"./framework-bafc524a.js";const t={},p=e(`<h1 id="docker-搭建-mysql-环境" tabindex="-1"><a class="header-anchor" href="#docker-搭建-mysql-环境" aria-hidden="true">#</a> Docker 搭建 MySQL 环境</h1><nav class="table-of-contents"><ul></ul></nav><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull mysql:8.0.32
