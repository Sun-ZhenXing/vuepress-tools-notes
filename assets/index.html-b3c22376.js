...
</code></pre></div>`,10);function _(f,x){const e=i("ExternalLinkIcon");return t(),o("div",null,[d,p,g,v,n("div",u,[m,n("p",null,[s("各种常用的 "),h,s(" 文件在 "),n("a",k,[s("GitHub"),c(e)]),s(" 可以参考，可以根据工程性质直接复制它们。另外有很多工程初始化就加上了这个文件，例如 Vue 项目创建时。")])]),b])}const G=a(r,[["render",_],["__file","index.html.vue"]]);export{G as default};
