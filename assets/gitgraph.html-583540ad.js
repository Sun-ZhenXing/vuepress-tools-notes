import{_ as d,M as n,p as a,q as t,N as c,a1 as e}from"./framework-546207d5.js";const l={},s=e(`<h1 id="mermaid-git-图" tabindex="-1"><a class="header-anchor" href="#mermaid-git-图" aria-hidden="true">#</a> Mermaid Git 图</h1><nav class="table-of-contents"><ul></ul></nav><p>Git 图形是不同分支上的 Git 提交和 Git 操作（命令）的图形化表示。</p><p>这类图表对开发者和开发团队分享他们的 Git 分支策略特别有帮助。例如，它使人们更容易直观地了解 Git 流程的工作原理。</p><p>Mermaid可以渲染Git图</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>gitGraph
   commit
   commit
   branch develop
   checkout develop
