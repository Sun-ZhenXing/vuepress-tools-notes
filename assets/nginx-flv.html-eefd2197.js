import{_ as d,r as c,o as k,c as v,b as n,a as e,w as a,d as s,e as r}from"./app-bd1d9ffa.js";const m={},g=n("h1",{id:"docker-部署-rtmp-流媒体服务器",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker-部署-rtmp-流媒体服务器","aria-hidden":"true"},"#"),s(" Docker 部署 RTMP 流媒体服务器")],-1),b=n("p",null,"Docker 部署 RTMP 流媒体服务器，在一端使用 RTMP 协议推流，并在前端播放直播内容。",-1),h={class:"table-of-contents"},f=n("h2",{id:"_1-创建-docker-容器",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-创建-docker-容器","aria-hidden":"true"},"#"),s(" 1. 创建 Docker 容器")],-1),_=n("p",null,"拉取镜像：",-1),x=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"docker"),s(` pull ubuntu:20.04
`)])])],-1),y=n("p",null,"创建 Docker 容器：",-1),w=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"docker"),s(" run "),n("span",{class:"token parameter variable"},"-itd"),s(),n("span",{class:"token punctuation"},"\\"),s(`
    `),n("span",{class:"token parameter variable"},"--name"),s(" nginx-flv "),n("span",{class:"token punctuation"},"\\"),s(`
    `),n("span",{class:"token parameter variable"},"-p"),s(),n("span",{class:"token number"},"1935"),s(":1935 "),n("span",{class:"token punctuation"},"\\"),s(`
    `),n("span",{class:"token parameter variable"},"-p"),s(),n("span",{class:"token number"},"8089"),s(":8089 "),n("span",{class:"token punctuation"},"\\"),s(`
    ubuntu:20.04 `),n("span",{class:"token punctuation"},"\\"),s(`
    /bin/bash
`)])])],-1),q=n("p",null,"拉取镜像：",-1),z=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"docker"),s(` pull centos:7.9.2009
`)])])],-1),P=n("p",null,"创建 Docker 容器：",-1),D=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"docker"),s(" run "),n("span",{class:"token parameter variable"},"-itd"),s(),n("span",{class:"token punctuation"},"\\"),s(`
    `),n("span",{class:"token parameter variable"},"--name"),s(" nginx-flv "),n("span",{class:"token punctuation"},"\\"),s(`
    `),n("span",{class:"token parameter variable"},"-p"),s(),n("span",{class:"token number"},"1935"),s(":1935 "),n("span",{class:"token punctuation"},"\\"),s(`
    `),n("span",{class:"token parameter variable"},"-p"),s(),n("span",{class:"token number"},"8089"),s(":8089 "),n("span",{class:"token punctuation"},"\\"),s(`
    centos:7.9.2009 `),n("span",{class:"token punctuation"},"\\"),s(`
    /bin/bash
...
</code></pre></div><p>下面的命令都在容器内执行。</p><h2 id="_2-源码编译" tabindex="-1"><a class="header-anchor" href="#_2-源码编译" aria-hidden="true">#</a> 2. 源码编译</h2>`,4),E=n("p",null,"请先配置好镜像源，然后更新并安装包：",-1),$=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"apt"),s(` update

`),n("span",{class:"token function"},"apt"),s(),n("span",{class:"token function"},"install"),s(" gcc "),n("span",{class:"token function"},"wget"),s(),n("span",{class:"token function"},"unzip"),s(),n("span",{class:"token function"},"make"),s(`
`),n("span",{class:"token function"},"apt"),s(),n("span",{class:"token function"},"install"),s(` openssl libssl-dev
`),n("span",{class:"token function"},"apt"),s(),n("span",{class:"token function"},"install"),s(` libpcre3 libpcre3-dev
`),n("span",{class:"token function"},"apt"),s(),n("span",{class:"token function"},"install"),s(` zlib1g-dev
`)])])],-1),A=n("p",null,"请先配置好镜像源，然后更新并安装包：",-1),I=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[s(`yum update

yum `),n("span",{class:"token function"},"install"),s(` gcc
yum `),n("span",{class:"token function"},"install"),s(` pcre pcre-devel
yum `),n("span",{class:"token function"},"install"),s(` openssl openssl-devel
yum `),n("span",{class:"token function"},"install"),s(),n("span",{class:"token function"},"wget"),s(),n("span",{class:"token function"},"unzip"),s(`
`)])])],-1),T={href:"http://nginx.org/",target:"_blank",rel:"noopener noreferrer"},O=r(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> http://nginx.org/download/nginx-1.23.3.tar.gz
...
<span class="token function">docker</span> run <span class="token parameter variable">-itd</span> <span class="token punctuation">\\</span>
    ...
    nginx-flv:v1
</code></pre></div>`,23);function N(Y,j){const t=c("router-link"),i=c("Tabs"),u=c("ExternalLinkIcon");return k(),v("div",null,[g,b,n("nav",h,[n("ul",null,[n("li",null,[e(t,{to:"#_1-创建-docker-容器"},{default:a(()=>[s("1. 创建 Docker 容器")]),_:1})]),n("li",null,[e(t,{to:"#_2-源码编译"},{default:a(()=>[s("2. 源码编译")]),_:1})]),n("li",null,[e(t,{to:"#_3-直播推流"},{default:a(()=>[s("3. 直播推流")]),_:1})]),n("li",null,[e(t,{to:"#_4-使用-dockerfile"},{default:a(()=>[s("4. 使用 Dockerfile")]),_:1})])])]),f,e(i,{id:"12",data:[{title:"Ubuntu 20.04"},{title:"CentOS 7.9.2009"}],"tab-id":"sys"},{tab0:a(({title:p,value:l,isActive:o})=>[_,x,y,w]),tab1:a(({title:p,value:l,isActive:o})=>[q,z,P,D]),_:1}),C,e(i,{id:"44",data:[{title:"Ubuntu 20.04"},{title:"CentOS 7.9.2009"}],"tab-id":"sys"},{tab0:a(({title:p,value:l,isActive:o})=>[E,$]),tab1:a(({title:p,value:l,isActive:o})=>[A,I]),_:1}),n("p",null,[s("编译 Nginx 和 HTTP-FLV，"),n("a",T,[s("Nginx 官网"),e(u)]),s(" 可以查看最新版本：")]),O])}const L=d(m,[["render",N],["__file","nginx-flv.html.vue"]]);export{L as default};
