import{_ as s,M as l,p as r,q as h,R as e,N as a,V as i,t,a1 as d}from"./framework-35c50e38.js";const u={},g=e("h1",{id:"时序图",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#时序图","aria-hidden":"true"},"#"),t(" 时序图")],-1),_={class:"table-of-contents"},m=d('<h2 id="_1-时序图介绍" tabindex="-1"><a class="header-anchor" href="#_1-时序图介绍" aria-hidden="true">#</a> 1. 时序图介绍</h2><p><strong>时序图</strong>（Sequence Diagram）又名序列图、循序图，是一种 UML 交互图。它通过描述对象之间发送消息的时间顺序显示多个对象之间的动态协作。它可以表示用例的行为顺序，当执行一个用例行为时，其中的每条消息对应一个类操作或状态机中引起转换的触发事件。<sup class="footnote-ref"><a href="#footnote1">[1]</a><a class="footnote-anchor" id="footnote-ref1"></a></sup></p>',2),x=d(`<p>时序图中包括如下元素：角色，对象，生命线，控制焦点和消息。</p><ol><li><strong>角色</strong>（Actor）：系统角色，可以是人或者其他系统，子系统。</li><li><strong>对象</strong>（Object）：对象是类的实例，以一个矩形表示，位于时序图的顶部的对象是类角色。对象有三种状态：激活、运行（存在）和销毁，对象一般命名方式如下： <ol><li>包含对象名和类名</li><li>只显示类名不显示对象名，即为一个匿名对象</li><li>只显示对象名不显示类名</li></ol></li><li><strong>生命线</strong>（Lifeline）：生命线代表时序图中的对象在一段时期内的存在。时序图中每个对象和底部中心都有一条垂直的虚线，这就是对象的生命线，对象间的消息存在于两条虚线间。</li><li><strong>控制焦点</strong>（Activation）：控制焦点代表时序图中的对象执行一项操作的时期，在时序图中每条生命线上的窄矩形代表活动期。</li><li><strong>消息</strong>（Message）：消息是定义交互和协作中交换信息的类，用于对实体间的通信内容建模，信息用于在实体间传递信息。允许实体请求其他的服务，类角色通过发送和接受信息进行通信。</li></ol><h2 id="_2-mermaid-时序图语法" tabindex="-1"><a class="header-anchor" href="#_2-mermaid-时序图语法" aria-hidden="true">#</a> 2. Mermaid 时序图语法</h2><div class="hint-container info"><p class="hint-container-title">关键字</p><p>如果节点使用 <code>end</code> 命名可能导致绘图中断，因此，应该尽可能使用引号（<code>&quot;&quot;</code>）或括号（<code>[] {} ()</code>）来包裹 <code>end</code> 这个词。</p></div><h3 id="_2-1-参与者" tabindex="-1"><a class="header-anchor" href="#_2-1-参与者" aria-hidden="true">#</a> 2.1 参与者</h3><div class="language-text" data-ext="text"><pre class="language-text"><code>sequenceDiagram
